...
function Content2() {
  ...
  <div className='all grid grid-cols-2'>
    ...
    <div class="container mt-10 flex justify-center items-center sm:px-2 lg:px-2">
        <div class="relative "> <input type="text" class="h-14 w-96 pr-4 pl-5 border border-sky-500 rounded-full  z-0 focus:shadow focus:outline-none" placeholder="Search Classes..."/>
        ...
        <div className="img1 flex grid-cols-1 gap-40 place-content-center">
